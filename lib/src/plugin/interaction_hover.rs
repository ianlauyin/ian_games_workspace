...
pub struct InteractionHoverPlugin;

impl Plugin for InteractionHoverPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Update, handle_interaction_hover);
    }
}

fn handle_interaction_hover(
    ...
    for (interaction, background_color_op, text_color_op) in interaction_query.iter_mut() {
        match interaction {
